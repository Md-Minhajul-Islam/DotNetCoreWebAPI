...
{
    private readonly IMemoryCache _cache; // used to store memory
    ...
    public void AddItem(CartItem item)
    {
        ...
        var cart = _cache.GetOrCreate(_userId, entry =>
        {
            ...
            // Reset expriration timer when accessed
            return new List<CartItem>(); // Start with empty cart for this user
        
        })!; // The "!" tells compiler: "this whill never be null"
    ...
    public List<CartItem> GetItems()
    {
        ...
        return _cache.TryGetValue(_userId, out List<CartItem>? cart) && cart != null ?
